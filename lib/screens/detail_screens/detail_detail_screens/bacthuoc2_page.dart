...
import 'package:applichsu/data/bacthuoc2_data.dart';
import 'package:applichsu/widgets/bacthuoc2_widget.dart';
...
class BacThuoc2Page extends StatefulWidget {
  const BacThuoc2Page({super.key});
  @override
  _BacThuoc2PageState createState() => _BacThuoc2PageState();
}
class _BacThuoc2PageState extends State<BacThuoc2Page>{
  int _screenIndex = 0;
  bool shorten = true;
  ...
  void onSelectBacThuoc2Model(int index){
    if(index == 20){
      Navigator.push(
        context,
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                const Image(image: AssetImage('assets/images/period_details2_3.png')),
                ...
                const Expanded(
                  child: SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Text(
                        'Bắc thuộc lần thứ hai (ngắn gọn: Bắc thuộc lần 2) trong lịch sử Việt Nam kéo dài khoảng 500 năm từ năm 43 đến năm 543, từ khi Mã Viện theo lệnh Hán Quang Vũ Đế nhà Đông Hán đánh chiếm lại bộ Giao Chỉ từ tay Trưng Vương, đến khi Lý Bí khởi binh đánh đuổi thứ sử nhà Lương là Tiêu Tư năm 542 rồi lập ra nước Vạn Xuân năm 544.',
                        softWrap: true,
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 14,
                ...
                Expanded(
                    child: GridView(
                      ...
                      children: [
                        for(final bacthuoc2Model in bacthuoc2Data)
                          BacThuoc2Widget(
                            bacthuoc2Model: bacthuoc2Model,
                            onSelectBacThuoc2Model: onSelectBacThuoc2Model,
                          ),
                      ],
                    ),
                  ),
