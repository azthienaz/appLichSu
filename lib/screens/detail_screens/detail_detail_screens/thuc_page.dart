...
import 'package:applichsu/data/thuc_data.dart';
import 'package:applichsu/widgets/thuc_widget.dart';
...
class ThucPage extends StatefulWidget {
  const ThucPage({super.key});
  @override
  _ThucPageState createState() => _ThucPageState();
}
class _ThucPageState extends State<ThucPage>{
  int _screenIndex = 0;
  bool shorten = true;
  ...
  void onSelectThucModel(int index){
    Navigator.push(
      context,
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                const Image(image: AssetImage('assets/images/thuc.png')),
                ...
                Expanded(
                    child: GridView(
                      ...
                      children: [
                        for(final thucModel in thucData)
                          ThucWidget(
                            thucModel: thucModel,
                            onSelectThucModel: onSelectThucModel,
                          ),
                      ],
                    ),
                  ),
