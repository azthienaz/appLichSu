...
class NhaHanPage extends StatefulWidget {
  const NhaHanPage({super.key});
  @override
  _NhaHanPageState createState() => _NhaHanPageState();
}
class _NhaHanPageState extends State<NhaHanPage>{
  int _screenIndex = 0;
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: 
          const Column(
            children: [
              Image(image: AssetImage('assets/images/nhahan.png')),
              SizedBox(height: 8,),
              Text(
                "111 TCN - 39",
